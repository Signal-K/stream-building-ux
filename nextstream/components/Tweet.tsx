...
const Metric = ({ icon, count, title = null, iconSize = 14 }: { icon: any, count: any, title: any, iconSize: any }) => {
...
const Account = ({ entity, currentStream, addEntityToStream }: { entity: any, currentStream: any, addEntityToStream: any, }) => {
