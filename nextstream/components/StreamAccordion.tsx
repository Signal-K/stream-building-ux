...
const AccordionSummary = ({ streamName, isOpen, setStream }: { streamName: any, isOpen: any, setStream: any }) => {
...
const InlineEntity = ({ name, kind }: { name: any, kind: any }) => {
      ...
      <div className="h-full" ref={accordionRef}>
        ...
        <div
          className={cn(
            ...
            {
              "backdrop-blur-sm bg-radial overflow-y-scroll overflow-x-hidden":
                currentStream,
            },
...
const StreamSidebar: React.FC<StreamSidebarProps> = ({
    streams,
    lists,
    inFocus,
    currentStream,
